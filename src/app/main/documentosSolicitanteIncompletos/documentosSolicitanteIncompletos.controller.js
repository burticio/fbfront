(function () {
    ...
    angular
        ...
        .controller('DocumentoSolicitanteIncompletosController', DocumentoSolicitanteIncompletosController);

    /** @ngInject */
    function DocumentoSolicitanteIncompletosController($scope, localStorageService, msNavigationService, $state, $mdDialog) {
        var vm = this;
        ...
        function init() {
            vm.mostrarCargando();
            $scope.aux = [];
            AjaxCall("GET", URL_SERVIDOR + "/ApplicationDocIncomp", null, function (response) {
