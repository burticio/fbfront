(function () {
    ...
    angular
        ...
        .controller('DocumentoSolicitanteCompletosController', DocumentoSolicitanteCompletosController);

    /** @ngInject */
    function DocumentoSolicitanteCompletosController($scope, localStorageService, msNavigationService, $state, $mdDialog) {
        var vm = this;
        ...
        function init() {
            vm.mostrarCargando();
            $scope.aux = [];
            AjaxCall("GET", URL_SERVIDOR + "/ApplicationDocComp", null, function (response) {
