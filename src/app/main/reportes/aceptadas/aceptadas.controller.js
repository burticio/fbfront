(function () {
    ...
    angular
        .module('app.reporteaceptadas')
        .controller('AceptadasController', AceptadasController);

    function AceptadasController($scope, $mdDialog, localStorageService, $sce,$state) {
                                    ...
                                    AjaxCall("POST", URL_SERVIDOR + "/ApplicationDocument/showPerApplication", objData, function (response) {
                                        ...
                                        AjaxCall("POST", URL_SERVIDOR + "/ApplicationDocumentFA/showPerApplication", objData, function (response) {
                                            ...
                                            $mdDialog.show({
                                                ...
                                                templateUrl: 'app/main/reportes/aceptadas/html/dialogo.mostrardetalle.html',
        ...
        $scope.downloadFile = function(){
            vm.mostrarCargando();
            window.location.href = URL_SERVIDOR + "/Reports/exportaccepted";
            setTimeout(function(){
                vm.cerrarCargando();
            }, 500);
        }
        ...
        function initDatatable() {
            vm.upload = false;
            AjaxCall("GET", URL_SERVIDOR + "/Reports/listaccepted", null, function (response) {
                $scope.$apply(function () {
