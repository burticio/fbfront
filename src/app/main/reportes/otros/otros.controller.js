(function () {
    ...
    angular
        .module('app.reporteotros')
        .controller('OtrosController', OtrosController);

    function OtrosController($scope, $mdDialog, localStorageService, $sce,$state) {
                                    ...
                                    AjaxCall("POST", URL_SERVIDOR + "/ApplicationDocument/showPerApplication", objData, function (response) {
                                        ...
                                        AjaxCall("POST", URL_SERVIDOR + "/ApplicationDocumentFA/showPerApplication", objData, function (response) {
                                            ...
                                            $mdDialog.show({
                                                ...
                                                templateUrl: 'app/main/reportes/otros/html/dialogo.mostrardetalle.html',
        ...
        $scope.downloadFile = function(){
            vm.mostrarCargando();
            window.location.href = URL_SERVIDOR + "/Reports/exportcanalizeother";
            setTimeout(function(){
                vm.cerrarCargando();
            }, 500);
        }
        ...
        function initDatatable() {
            vm.upload = false;
            AjaxCall("GET", URL_SERVIDOR + "/Reports/listcanalizeother", null, function (response) {
                $scope.$apply(function () {
