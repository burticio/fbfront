(function () {
    ...
    angular
        .module('app.reporteaceptadasgenerales')
        .controller('AceptadasGeneralesController', AceptadasGeneralesController);

    function AceptadasGeneralesController($scope, $mdDialog, localStorageService, $sce,$state) {
                                    ...
                                    AjaxCall("POST", URL_SERVIDOR + "/ApplicationDocument/showPerApplication", objData, function (response) {
                                        ...
                                        AjaxCall("POST", URL_SERVIDOR + "/ApplicationDocumentFA/showPerApplication", objData, function (response) {
                                            ...
                                            $mdDialog.show({
                                                ...
                                                templateUrl: 'app/main/reportes/aceptadasgenerales/html/dialogo.mostrardetalle.html',
        ...
        function MostrarDetalleController($scope, $mdDialog, solicitud, criterialNames, criterialValues, arraysolicitud, arrayentrevista, country, bycountry, arraycountries, arrayuniversities, arrayProgram_Types, arrayProgram_Modalities, documentos, documentosaceptacion) {
        ...
        $scope.downloadFile = function () {
            vm.mostrarCargando();
            window.location.href = URL_SERVIDOR + "/Reports/exportacceptedtotal";
            setTimeout(function () {
                vm.cerrarCargando();
            }, 500);
        }
        ...
        function initDatatable() {
            vm.upload = false;
            AjaxCall("GET", URL_SERVIDOR + "/Reports/listacceptedtotal", null, function (response) {
                $scope.$apply(function () {
