(function () {
    ...
    angular
        .module('app.reporterechazadas')
        .controller('RechazadasController', RechazadasController);

    function RechazadasController($scope, $mdDialog, localStorageService,$state) {
                                ...
                                AjaxCall("POST", URL_SERVIDOR + "/InterviewQualificationCriteria/listinterview", dataCalifications, function (response) {
                                    ...
                                    AjaxCall("POST", URL_SERVIDOR + "/ApplicationDocument/showPerApplication", objData, function (response) {
                                        ...
                                        $mdDialog.show({
                                            ...
                                            templateUrl: 'app/main/reportes/rechazadas/html/dialogo.mostrardetalle.html',
        ...
        function MostrarDetalleController($scope, $mdDialog, solicitud, criterialNames, criterialValues, arraysolicitud, arrayentrevista, country, bycountry, arraycountries, arrayuniversities, arrayProgram_Types, arrayProgram_Modalities, documentos) {
        ...
        $scope.downloadFile = function(){
            vm.mostrarCargando();
            window.location.href = URL_SERVIDOR + "/Reports/exportrejectedtotal";
            setTimeout(function(){
                vm.cerrarCargando();
            }, 500);
        }
        ...
        function initDatatable() {
            vm.upload = false;
            AjaxCall("GET", URL_SERVIDOR + "/Reports/listrejectedtotal", null, function (response) {
                $scope.$apply(function () {
