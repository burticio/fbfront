(function () {
    ...
    angular
        ...
        .controller('DocumentoSolicitanteVaciosController', DocumentoSolicitanteVaciosController);

    /** @ngInject */
    function DocumentoSolicitanteVaciosController($scope, localStorageService, msNavigationService, $state, $mdDialog) {
        var vm = this;
        ...
        function init() {
            vm.mostrarCargando();
            $scope.aux = [];
            AjaxCall("GET", URL_SERVIDOR + "/ApplicationDocEmp", null, function (response) {
