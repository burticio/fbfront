(function () {
    ...
    angular
        ...
        .controller('InicioOperadorVistaController', InicioOperadorVistaController);

    /** @ngInject */
    function InicioOperadorVistaController($scope, localStorageService, msNavigationService) {
        var vm = this;
