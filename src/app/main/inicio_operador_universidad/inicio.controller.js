(function () {
    ...
    angular
        ...
        .controller('InicioOperadorUniversidadController', InicioOperadorUniversidadController);

    /** @ngInject */
    function InicioOperadorUniversidadController($scope, localStorageService, msNavigationService, $state) {
        var vm = this;
