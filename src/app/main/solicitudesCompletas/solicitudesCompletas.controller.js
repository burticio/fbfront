(function () {
    ...
    angular
        .module('app.solicitudesCompletas')
        .controller('solicitudesCompletasController', solicitudesCompletasController);

    /** @ngInject */
    function solicitudesCompletasController($scope, localStorageService, msNavigationService, $state, $mdDialog) {
        var vm = this;
        ...
        $scope.verDetalle = function (ev, data){
            $mdDialog.show({
                ...
                templateUrl : 'app/main/solicitudesCompletas/html/modalDetalle.html',
                parent             : angular.element('body'),
                targetEvent        : ev,
                locals             : {
                    formWizardData: data
        ...
        $scope.dlgcancelarSolicitud = function (ev, solicitud) {
            $mdDialog.show({
                ...
                templateUrl: 'app/main/solicitudesCompletas/html/dialogo.cancelarsolicitud.html',
                parent: angular.element('body'),
        ...
        $scope.downloadFile = function(){
            vm.mostrarCargando();
            window.location.href = URL_SERVIDOR + "/Reports/exportcomplete";
            setTimeout(function(){
                vm.cerrarCargando();
            }, 500);
        }
        ...
        function init() {
            vm.mostrarCargando();
            $scope.aux = [];
            AjaxCall("GET", URL_SERVIDOR + "/ApplicationComplete", null, function (response) {
