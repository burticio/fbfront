(function () {
    ...
    angular
        ...
        .controller('solicitudesActivasController', solicitudesActivasController);

    /** @ngInject */
    function solicitudesActivasController($scope, localStorageService, msNavigationService, $state, $mdDialog) {
        var vm = this;
        ...
        $scope.verDetalle = function (ev, data){
            $mdDialog.show({
                ...
                templateUrl : 'app/main/solicitudesActivas/html/modalDetalle.html',
                parent             : angular.element('body'),
                targetEvent        : ev,
                locals             : {
                    formWizardData: data
        ...
        $scope.dlgcancelarSolicitud = function (ev, solicitud) {
            $mdDialog.show({
                ...
                templateUrl: 'app/main/solicitudesActivas/html/dialogo.cancelarsolicitud.html',
                parent: angular.element('body'),
        ...
        $scope.downloadFile = function(){
            vm.mostrarCargando();
            window.location.href = URL_SERVIDOR + "/Reports/exportactive";
            setTimeout(function(){
                vm.cerrarCargando();
            }, 500);
        }
        ...
        $scope.dlgcambiarPrograma = function (ev, solicitud) {
            $mdDialog.show({
                ...
                templateUrl: 'app/main/solicitudesActivas/html/dialogo.cambiarprograma.html',
                parent: angular.element('body'),
                targetEvent: ev,
                locals: { 
        ...
        function CambiarProgramaController($scope, $mdDialog, localSolicitud) {
            ...
            $scope.borrarFiltros = function(){
                ...
                AjaxCall("GET", URL_SERVIDOR + "/availableFilters", null, function (response) {
                    ...
                    $scope.clasificacion.modelo = $scope.solicitud.Classification_Id;
                });
            }
            $scope.borrarFiltros();
        }
        ...
        function init() {
            vm.mostrarCargando();
            $scope.aux = [];
            AjaxCall("GET", URL_SERVIDOR + "/ApplicationActive", null, function (response) {
