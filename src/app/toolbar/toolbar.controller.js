(function ()
{
    ...
    {
        var vm = this;
        vm.username = localStorageService.get("session_name");
        vm.username += " " + localStorageService.get("session_lastName");
        vm.username +=" " +  localStorageService.get("session_mLastName");
        // Data
        $rootScope.global = {
            search: ''
        };
